...
class Map {
    ...
    setMarkers(options, oldMarkers) {
        ...
        for(let i = 0; i < options.length; i++) {
            ...
            marker.bindPopup('<b>' + options[i].name + '</b><br>' + '<div class="starContainer"><img src="/stars.png" class="stars"><div class="starCover" style="width:' + rating + '%"></div></div>' + '(' + options[i].rating + ') ' + price + " " + options[i].distText + directionsHTML);
            markers.push(marker);
